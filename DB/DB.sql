...
(52, 2, '71895719', NULL, 'NELSON FRANCISCO PEREZ LOPEZ', '1996-12-12', NULL, 'CALLE MEXICO 123', '2019-03-01 09:38:51', 1, 0, 0, 7, 'Boliviana', 'SOLTERO', 'Estudiante', 'Bus', 'La Paz', 'Trusimo', NULL, NULL);
...
(3, 'PRO-0003-R', 'Gaseosa Coca Cola', 'Coca Cola', 'Personal medio litro', NULL, 0, 10, 24, 0, '2018-02-16 20:59:18');
INSERT INTO `producto` (`id`, `codigo`, `nombre`, `marca`, `descripcion`, `presentacion`, `precio_compra`, `precio_venta`, `stock`, `id_proveedor`, `fecha_creada`) VALUES
(4, 'PRO-0001-C', 'Copacabana trio', 'Copacabana', 'Combo trio', NULL, 50, 70, 24, 0, '2018-02-16 20:59:18');
