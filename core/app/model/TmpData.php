...
// partiendo de que ya tenemos creado un objecto UserData previamente utilizamos el contexto
	...
	//eduardo
	public static function getByIdYSessionYTipo($idprod,$idsesion, $tipo){
		$sql = "select * from ".self::$tablename." where id_producto=$idprod and sessionn_id=\"$idsesion\" and tipo_operacion = $tipo";
		$query = Executor::doit($sql);
		return Model::one($query[0],new TmpData());
